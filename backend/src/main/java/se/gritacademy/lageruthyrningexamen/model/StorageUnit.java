package se.gritacademy.lageruthyrningexamen.model;
...
public class StorageUnit {
    ...
    @Column(name = "size_m2", nullable = false, precision = 10, scale = 2)
    ...
    @OneToMany(mappedBy = "storageUnit", fetch = FetchType.EAGER)
    @JsonIgnore
    ...
    public void setSizeM2(BigDecimal sizeM2) { this.sizeM2 = sizeM2; }
